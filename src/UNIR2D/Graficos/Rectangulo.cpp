...
void Rectangulo::dibuja (const Transforma & contenedor, Rendidor * rendidor) {
    Dibujable::situa (this->shape, contenedor, this->m_transforma);
	rendidor->window->draw (this->shape);
}
